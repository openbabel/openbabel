...
namespace happyhttp
{
  ...
  EXTERN bool IsWebAddress(const std::string& name, std::stringstream* ss );
  EXTERN void HttpToStream(std::stringstream* pss, const std::string& host, const std::string& datatext);
  //End Copyright (c) 2011 Chris Morley
