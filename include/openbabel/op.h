...
namespace OpenBabel
{
  /** @class OBOp op.h <openbabel/op.h>
      ...
      babel -L ops or from a menu item in the GUI.
  ...
  class OBAPI OBOp : public OBPlugin
  {
    ...
    public:
      ...
      /** 
       * @brief Provides the name of this kind of plugin. Use -L "ops" to list 
       * from commandline.
       * 
      ...
      /** 
       * @brief Required function that does the work. Normally return true, unless object is not to be output.
       * 
       * @param pOb The class (see WorksWith())
       * @param pOptions The options.
       * @param OptionText
       * 
       * @return True, unless object is not to be output. 
       */
      ...
      /** 
       * @return String describing options, for display with -H and to make 
       * checkboxes in GUI.
       */
      ...
      /** 
       * @brief Call Do() of all the OBOps whose ID is a key in the map.
       * 
       * @param pOb The class (see WorksWith())
       * @param pOptions The options.
       * 
       * @return False indicating object should not be output, if any Do() 
       * returns false.
       *
       * Called from Transform(). The map has general options like -x or --multicharoption.
       * The key is the option name and the value, if any, is text which follows the option 
       * name.  In some cases, there may be several parameters, space separated).
       */
