...
namespace OpenBabel
{
  ...
  //! OBBond flags (AromaticBond, InRing, ...)
  ...
  class OBAPI OBBond: public OBBase
  {
    ...
    public:
      ...
      //! @name Bond modification methods
      //@{
      /** 
       ...
       */
      void SetAromatic() { SetFlag(OBBondFlag::AromaticBond); }
      /** 
      ...
      /** 
       * Mark that this bond has an "up" torsion for double-bond stereochem 
       * (i.e., "/" in SMILES notation).
       */
      void SetUp() { SetFlag(OBBondFlag::Up); UnsetFlag(OBBondFlag::Down); }
      /** 
       * Mark that this bond has an "down" torsion for double-bond stereochem 
       * (i.e., "\" in SMILES notation).
       */
       ...
       * automatically by lazy evaluation when requesting OBBond::IsClosure() 
       */
       ...
       */
      void UnsetAromatic() { UnsetFlag(OBBondFlag::AromaticBond); }
      /** 
      ...
      //! @name Bond data request methods
      //@{
      /** 
       ...
       */
      unsigned int GetBondOrder() const { return m_order; }
      /** 
       ...
       */
      OBAtom* GetBeginAtom() { return m_bgn; }
      /** 
       * @return The "beginning" atom for this bond.
       */
      const OBAtom* GetBeginAtom() const { return m_bgn; } 
      /** 
       * @return The "end" atom for this bond.
       */
      OBAtom* GetEndAtom() { return m_end; }
      /** 
       * @return The "end" atom for this bond.
       */
      const OBAtom* GetEndAtom() const { return m_end; }
      /** 
       ...
       */
      OBMol* GetParent() { return m_parent; }
      /** 
       ...
       * @warning If @p ptr is not part of the bond, the beginning atomindex will always be returned. 
       */
      unsigned int GetNbrAtomIdx(OBAtom *ptr);
      //@}

      //! @name property request methods
      //@{
      /** @return Is the bond aromatic? 
       * (Note that the two atoms of the bond may be aromatic, but not the bond)
       */
