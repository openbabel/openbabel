								...
								public:
												...
												virtual const char* Description() //required
												{
																return
																				...
																				"Output is a list of {x,y,z} tuples in Angstrom in xyz format\n\n"
																				"Write Options, e.g. -xr\n"
																				"  r comma-separated list of VDW radius multiples        (default 1.0)\n"
				...
				bool PointCloudFormat::WriteMolecule( OBBase* pOb, OBConversion* pConv )
				{
								...
								for( int j = 0; j < radius_mult_list.size(); j++ ) {
												...
												FOR_ATOMS_OF_MOL( a, *pmol )
												{
																...
																double vdwrad   = etab.GetVdwRad( a->GetAtomicNum() ) * radius_mult;
