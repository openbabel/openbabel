/*
SVGBSFormat.cpp  Format for rendering multiple molecules by SVG
...
public:
  ...
  {
    return
      "SVG 2D ball and stick depiction\n"
...
/////////////////////////////////////////////////////////////////
SVGBSFormat theSVGBSFormat;

/////////////////////////////////////////////////////////////////
bool SVGBSFormat::WriteChemObject(OBConversion* pConv)
{
...
////////////////////////////////////////////////////////////////
bool SVGBSFormat::WriteMolecule(OBBase* pOb, OBConversion* pConv)
{
  ...
  if( (pConv->IsOption("y") || !pmol->Has2D(true)) && !pConv->IsOption("n") )
  {
    ...
    if(!pOp)
    {
      obErrorLog.ThrowError("SVGBSFormat", "gen2D not found", obError, onceOnly);
      return false;
    }
    if(!pOp->Do(pmol))
    {
      obErrorLog.ThrowError("SVGBSFormat", string(pmol->GetTitle()) + "- Coordinate generation unsuccessful", obError);
      return false;
    }
  }
  if(!pmol->Has2D() && pmol->NumAtoms()>1)//allows 3D coordinates (if passed by -xn above)
  {
    string mes("Molecule ");
    mes += pmol->GetTitle();
    mes += " needs 2D coordinates to display in SVGBSFormat";
    obErrorLog.ThrowError("SVGBSFormat", mes, obError);
    return false;
  }
...
/////////////////////////////////////////////////////////////
//returns true if the file "SVGBSFormat.script" was inserted into the output
bool SVGBSFormat::EmbedScript(ostream& ofs)
{
  ifstream ifs;
  if(!ifs || OpenDatafile(ifs, "SVGBSFormat.script").empty())
    return false;
...
///////////////////////////////////////////////////////////////////////////////////
bool SVGBSFormat::EmbedCML(OBMol* pmol, OBConversion* pConv)
{
...
/*
The script below was originally (and still could be) in data/SVGBSFormat.script,
...
Alternatively, SVGBSFormat.script could contain:
