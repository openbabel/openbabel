...
static int INCHI_DECL GetINCHI( inchi_Input *inp, inchi_Output *out );
static void INCHI_DECL FreeINCHI ( inchi_Output *out );
static void INCHI_DECL FreeStructFromINCHI( inchi_OutputStruct *out );
static int INCHI_DECL GetStructFromINCHI( inchi_InputINCHI *inpInChI, 
                                         inchi_OutputStruct *outStruct );
static int INCHI_DECL GetINCHIfromINCHI( inchi_InputINCHI *inpInChI, inchi_Output *out );
...
/*************************************************************/
static int INCHI_DECL GetStructFromINCHI( inchi_InputINCHI *inpInChI, inchi_OutputStruct *outStruct )
{
...
int  cdecl_Get_std_inchi_Input_FromAuxInfo
...
int cdecl_Get_std_inchi_Input_FromAuxInfo
             ( char *szInchiAuxInfo, int bDoNotAddH, InchiInpData *pInchiInp )
{
    return Get_std_inchi_Input_FromAuxInfo
...
int  PASCAL pasc_Get_std_inchi_Input_FromAuxInfo
             ( char *szInchiAuxInfo, int bDoNotAddH, InchiInpData *pInchiInp );
