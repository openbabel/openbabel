...
struct HelixParameters
  ...
  size_t  bond_connect; // the zero-based index of the residue atome to bond from
  };
HelixParameters protein_helix = { 1.4781, 1.74474, 2 }; // HNCA-.N-CA-C-.N-CA-C-.OXT-HOCA
HelixParameters RNA_helix = { 2.95057, 0.560027, 8 }; // HTER-OXT-.P-O5'-C5'-C4'-C3'-O3'-.P-O5'-C5'-C4'-C3'-O3'-.HCAP
HelixParameters DNA_helix = { 3.37998, 0.628312, 8 }; // HTER-OXT-.P-O5'-C5'-C4'-C3'-O3'-.P-O5'-C5'-C4'-C3'-O3'-.HCAP
HelixParameters DNA_pair_helix = { -3.37998, -0.628312, 8 }; // Simply the negative of the above
