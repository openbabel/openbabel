...
if(BUILD_SHARED)
  ...
  if(ADD_INCHI_FORMAT)
    ...
    if(NOT OPENBABEL_USE_SYSTEM_INCHI)
      include_directories("${PROJECT_BINARY_DIR}/include/inchi")
      # XXX: InChI Debug build creates libinchid but not libinchi
      set(libs ${libs} "${PROJECT_BINARY_DIR}/${LIB_INSTALL_DIR}/libinchi$<$<STREQUAL:${CMAKE_BUILD_TYPE},Debug>:d>${CMAKE_SHARED_LIBRARY_SUFFIX}")
    else()
