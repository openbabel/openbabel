...
if(BUILD_SHARED)
  ...
  if(ADD_INCHI_FORMAT)
    ...
    if(NOT OPENBABEL_USE_SYSTEM_INCHI)
      include_directories("${PROJECT_SOURCE_DIR}/external/InChI/INCHI-1-SRC/INCHI_API/libinchi/src")
      set(libs ${libs} $<TARGET_FILE:libinchi>)
    else()
...
elseif(WITH_STATIC_INCHI)
  ...
  if(NOT MSVC AND NOT OPENBABEL_USE_SYSTEM_INCHI)
    include_directories(${PROJECT_SOURCE_DIR}/include/inchi)
  endif()
  set(formats_common
    ${formats_common}
    inchiformat
