...
bool ReadChemDraw(std::istream &,OBMol &,const char *title="Untitled");
...
bool ReadGaussianOut(std::istream &, OBMol &, const char *title="Untitled");
...
bool ReadTurbomole(std::istream &,OBMol &,const char *title="Untitled");
...
bool WriteTurbomole(std::ostream &,OBMol &);
