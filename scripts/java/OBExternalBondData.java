...
public class OBExternalBondData extends OBGenericData {
  ...
  public OBGenericData Clone(OBBase arg0) {
    long cPtr = net.sourceforge.openbabelJNI.OBExternalBondData_Clone(swigCPtr, OBBase.getCPtr(arg0));
    return (cPtr == 0) ? null : new OBGenericData(cPtr, false);
  }

  public void SetData(OBAtom arg0, OBBond arg1, int arg2) {
    net.sourceforge.openbabelJNI.OBExternalBondData_SetData(swigCPtr, OBAtom.getCPtr(arg0), OBBond.getCPtr(arg1), arg2);
  }

  public SWIGTYPE_p_std__vectorTOpenBabel__OBExternalBond_t GetData() {
    long cPtr = net.sourceforge.openbabelJNI.OBExternalBondData_GetData(swigCPtr);
