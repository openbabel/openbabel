...
public class OBRTree {
  ...
  public OBRTree(OBAtom arg0, OBRTree arg1) {
    this(net.sourceforge.openbabelJNI.new_OBRTree(OBAtom.getCPtr(arg0), OBRTree.getCPtr(arg1)), true);
  }

  public int GetAtomIdx() {
    return net.sourceforge.openbabelJNI.OBRTree_GetAtomIdx(swigCPtr);
  }

  public void PathToRoot(SWIGTYPE_p_std__vectorTOpenBabel__OBNodeBase_p_t arg0) {
    net.sourceforge.openbabelJNI.OBRTree_PathToRoot(swigCPtr, SWIGTYPE_p_std__vectorTOpenBabel__OBNodeBase_p_t.getCPtr(arg0));
  }
