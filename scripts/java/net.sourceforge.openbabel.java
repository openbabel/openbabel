...
public class net.sourceforge.openbabel implements net.sourceforge.openbabelConstants {
  ...
  public static void DoubleMultiply(long arg0, long arg1, DoubleType arg2) {
    net.sourceforge.openbabelJNI.DoubleMultiply(arg0, arg1, DoubleType.getCPtr(arg2), arg2);
  }

  public static void DoubleAdd(DoubleType arg0, long arg1) {
    net.sourceforge.openbabelJNI.DoubleAdd(DoubleType.getCPtr(arg0), arg0, arg1);
  }

  public static long DoubleModulus(DoubleType arg0, long arg1) {
    return net.sourceforge.openbabelJNI.DoubleModulus(DoubleType.getCPtr(arg0), arg0, arg1);
  }

  public static double Point2Plane(vector3 a, vector3 b, vector3 c, vector3 d) {
    return net.sourceforge.openbabelJNI.Point2Plane(vector3.getCPtr(a), a, vector3.getCPtr(b), b, vector3.getCPtr(c), c, vector3.getCPtr(d), d);
  }
  ...
  public static void setObErrorLog(OBMessageHandler value) {
    net.sourceforge.openbabelJNI.obErrorLog_set(OBMessageHandler.getCPtr(value), value);
  }
  ...
  public static void CartesianToInternal(SWIGTYPE_p_std__vectorTOpenBabel__OBInternalCoord_p_t arg0, OBMol arg1) {
    net.sourceforge.openbabelJNI.CartesianToInternal(SWIGTYPE_p_std__vectorTOpenBabel__OBInternalCoord_p_t.getCPtr(arg0), OBMol.getCPtr(arg1), arg1);
  }

  public static void InternalToCartesian(SWIGTYPE_p_std__vectorTOpenBabel__OBInternalCoord_p_t arg0, OBMol arg1) {
    net.sourceforge.openbabelJNI.InternalToCartesian(SWIGTYPE_p_std__vectorTOpenBabel__OBInternalCoord_p_t.getCPtr(arg0), OBMol.getCPtr(arg1), arg1);
  }
  ...
  public static void setEtab(OBElementTable value) {
    net.sourceforge.openbabelJNI.etab_set(OBElementTable.getCPtr(value), value);
  }
  ...
  public static void setTtab(OBTypeTable value) {
    net.sourceforge.openbabelJNI.ttab_set(OBTypeTable.getCPtr(value), value);
  }
  ...
  public static void setIsotab(OBIsotopeTable value) {
    net.sourceforge.openbabelJNI.isotab_set(OBIsotopeTable.getCPtr(value), value);
  }
  ...
  public static void setAromtyper(OBAromaticTyper value) {
    net.sourceforge.openbabelJNI.aromtyper_set(OBAromaticTyper.getCPtr(value), value);
  }
  ...
  public static void setAtomtyper(OBAtomTyper value) {
    net.sourceforge.openbabelJNI.atomtyper_set(OBAtomTyper.getCPtr(value), value);
  }
  ...
  public static void setChainsparser(OBChainsParser value) {
    net.sourceforge.openbabelJNI.chainsparser_set(OBChainsParser.getCPtr(value), value);
  }
  ...
  public static void setResdat(OBResidueData value) {
    net.sourceforge.openbabelJNI.resdat_set(OBResidueData.getCPtr(value), value);
  }
  ...
  public static boolean CompareRingSize(OBRing arg0, OBRing arg1) {
    return net.sourceforge.openbabelJNI.CompareRingSize(OBRing.getCPtr(arg0), arg0, OBRing.getCPtr(arg1), arg1);
  }
