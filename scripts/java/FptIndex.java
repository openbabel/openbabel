...
public class FptIndex {
  ...
  public void setFptdata(SWIGTYPE_p_std__vectorTunsigned_int_t value) {
    openbabelJNI.FptIndex_fptdata_set(swigCPtr, this, SWIGTYPE_p_std__vectorTunsigned_int_t.getCPtr(value));
  }

  public SWIGTYPE_p_std__vectorTunsigned_int_t getFptdata() {
    return new SWIGTYPE_p_std__vectorTunsigned_int_t(openbabelJNI.FptIndex_fptdata_get(swigCPtr, this), false);
  }

  public void setSeekdata(SWIGTYPE_p_std__vectorTunsigned_int_t value) {
    openbabelJNI.FptIndex_seekdata_set(swigCPtr, this, SWIGTYPE_p_std__vectorTunsigned_int_t.getCPtr(value));
  }

  public SWIGTYPE_p_std__vectorTunsigned_int_t getSeekdata() {
    return new SWIGTYPE_p_std__vectorTunsigned_int_t(openbabelJNI.FptIndex_seekdata_get(swigCPtr, this), false);
  }
